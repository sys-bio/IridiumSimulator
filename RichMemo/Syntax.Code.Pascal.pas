...
begin
  ...
  KeyWord.Word := ['cls', 'var', 'string', 'as', 'inherited', 'destructor',
  ...
  KeyWord := TKeyWord.Create;
  KeyWord.Word := ['cls', 'begin', 'end', 'asm', 'end.', 'class', 'record', 'try', 'finally', 'except'];
  ...
  KeyWord := TKeyWord.Create;
  KeyWord.Word := ['cls', 'if', 'then', 'case', 'do', 'else', 'for', 'with', 'repeat', 'until', 'while'];
