...
uses
  uRoadRunner, uAntimonyAPI, uCommonTypes;
...
const
  ...
  ALL_CATEGORIES: TObservableCategorySet =
    [ocFloating, ocBoundary, ocReactions,
     ocRatesOfChange, ocGlobalParameters, ocCompartments];
...
begin
  ...
  begin
    ...
    Idx := FSelectedYNames.IndexOf(Item.Text);
    if Item.IsChecked then
    begin
      if Idx < 0 then FSelectedYNames.Add(Item.Text);
    end
    else
    begin
